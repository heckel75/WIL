...
- **Repo:** Local only, `git init` in `d:\WinProjects\WIL`. Single `index.html` at root plus this log. Commits: Session 1 `922dfec`; Session 2 build `180a77e`; Session 2 log-close `1333172`; Session 3 recon/font `<RECON_COMMIT>`. No GitHub remote yet (deferred to deploy).
